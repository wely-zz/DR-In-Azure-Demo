...
This repository complements this [video series](https://www.youtube.com/playlist?list=PLe32w3jNLanrZ9_X58_3d13tQ5REMmnK3) where we demonstrated how to perform a failover on Web/App and Database when one of the region goes down. This solution uses a number of Azure services such as App Service, SQL Datbase, Traffic Manager, EventHub, Steam Analytics, Azure Function and Logic App.
...
Create an Azure account in your if don't have one ([Login/Register Azure Account](https://azure.microsoft.com/en-us/free/)).

### 2. Fork this repository

Fork this repo, and you will start editing your own version of this project. ([What is Fork?](https://help.github.com/en/github/getting-started-with-github/fork-a-repo)).

### 3. Getting ready your necessary keys and secrets

Firstly, we need to create AAD App Client and retreived several information such as **tenant_id, grant_type, client_id, client_secret**. We need them to initiate the database failover from Azure Functions.
...
Click below button (preferable by opening a new tab) to deploy your services using Azure ARM Template:
...
There are a list of parameters which we have prefilled but you're are welcome to change if you'd like to. I'd like to highlight a few important ones:
